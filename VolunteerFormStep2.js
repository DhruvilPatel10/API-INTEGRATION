...
const VolunteerFormStep2 = ({formData, setFormData, onBack, onNext }) => {
  ...
  setFormData((prevData) => {
    if (section) {
      // If it's an array section like experiences or education
      const updatedSection = [...prevData[section]];
      updatedSection[index] = { ...updatedSection[index], [name]: files ? files[0] : value };
      return { ...prevData, [section]: updatedSection };
    } else {
      // For normal inputs (like LinkedIn, Website)
    ...
    <div className="form-container">
      ...
      <div className="form-content">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <label>LinkedIn Profile Link* <input type="text" name="linkedin" value={formData.linkedin} onChange={(e) => handleChange(e)} required /></label>
          <label>Additional Website (Optional) <input type="text" name="website" value={formData.website} onChange={(e) => handleChange} /></label>
